...
<body>
    <nav class="navbar rounded-box flex w-full items-center px-20 py-5 justify-between gap-2 shadow-base-300/20 shadow-sm">
  ...
  <div class="navbar-center max-md:hidden">
    <ul class="menu menu-horizontal flex justify-between px-40 font-medium">
      <li><a href="#" class='mx-3'>Shop</a></li>
      <li><a href="#" class='mx-3'>Collections</a></li>
      <li><a href="#" class='mx-3'>Explore</a></li>
    </ul>
  </div>
